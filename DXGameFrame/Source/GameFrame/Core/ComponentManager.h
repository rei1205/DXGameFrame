...
public:
    ...
    /**
     * @brief シーン内のアクティブなレンダラーコンポーネントを取得する
     * @return レンダラーコンポーネント配列
     */
    std::vector<Renderer*> GetRenderers();

    /**
     * @brief シーン内のアクティブなカメラコンポーネントを取得する
     * @return カメラコンポーネント配列
     */
    std::vector<Camera*> GetCameras();

    /**
     * @brief シーン内のアクティブなDirectionalLightコンポーネントを取得する
     * @return DirectionalLightコンポーネント配列
     */
